            ...
            <nav class="bg-white border-b border-gray-100">
                        ...
                        <div class="flex">
                            ...
                            <div class="flex items-center shrink-0">
                                <Link :href="route('dashboard')">
                                    <div class="block w-auto font-bold h-9">FWP</div>
                                </Link>
                            </div>
                            ...
                            <div class="items-center hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <BreezeNavLink :href="route('planner')" :active="route().current('planner')">
                                    Planner
                                </BreezeNavLink>
                                ...
                                <div class="relative ml-3">
                                    <BreezeDropdown align="right" width="48">
                                        ...
                                        <template #content>
                                            <BreezeDropdownLink :href="route('inventory')" as="button">
                                                Inventory
                                            </BreezeDropdownLink>
                                            <BreezeDropdownLink :href="route('meals')" as="button">
                                                Meals
                                            </BreezeDropdownLink>
                                        </template>
                                    </BreezeDropdown>
                                ...
                                <div class="relative ml-3">
                                    <BreezeDropdown align="right" width="48">
                                        ...
                                        <template #content>
                                            <BreezeDropdownLink :href="route('workouts')" as="button">
                                                Workouts
                                            </BreezeDropdownLink>
                                        </template>
                                    </BreezeDropdown>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <BreezeResponsiveNavLink :href="route('planner')" :active="route().current('planner')">
                            Planner
                        </BreezeResponsiveNavLink>
                        
                        <span class="block px-4 pt-3">
                            <b>Food</b>
                        </span>
                        
                        <BreezeResponsiveNavLink :href="route('inventory')" :active="route().current('inventory')">
                            Inventory
                        </BreezeResponsiveNavLink>

                        <BreezeResponsiveNavLink :href="route('meals')"  :active="route().current('meals')">
                            Meals
                        </BreezeResponsiveNavLink>
                        ...
                        <BreezeResponsiveNavLink :href="route('workouts')" :active="route().current('workouts')">
                            Workouts
                        </BreezeResponsiveNavLink>
                    </div>
